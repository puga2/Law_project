  ...
  return (
    <>
      <div className=" bg-[#016241]  mx-auto h-[337px]  max-w-7xl rounded-b-3xl mb-15">
        <div className="hero-content px-25 py-20  justify-start items-start ">
          <div className="mx-0 ">
            <h1 className="text-6xl font-bold text-start tracking-wide">
              ANN Law Office
            </h1>
      ...
      <div className="hero bg-base-content mx-auto max-w-7xl mb-10">
        <div className="hero-content flex-col-reverse lg:flex-row-reverse justify-center items-start p-4 md:p-8 lg:p-12 w-full">
          <img src={home} className="max-w-xl lg:max-w-sm shadow-2xl mx-auto" />
          <div>
            <h1 className="text-4xl font-bold text-[#016241] tracking-wide">
              ANN Law Office is a <br /> leading full-service law firm <br />{" "}
              operating in Cambodia.
            </h1>
            <hr className="w-[480px] border-t-8 border-[#016241] my-4" />
