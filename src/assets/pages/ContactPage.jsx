...
const ContactPage = () => {
  return (
    <>
      <div>
        <div
          className="hero h-[60vh]  mb-40 relative"
          style={{
            backgroundImage:
        ...
        {/* contact */}
        <div className="max-w-7xl mx-auto px-4  bg-gray-700  absolute  left-1/2 top-9/11 -translate-x-1/2 -translate-y-1/2 w-full ">
          <div className="">
            <div className="flex justify-between flex-wrap">
              <div className="w-1/3 px-4 pt-20 pb-20 text-white ">
                <div className="flex flex-col items-center text-center">
                  <div className="bg-[#016241]  w-22 h-22 flex justify-center items-center rounded-full absolute top-[-3.5rem]">
                    <IoLocation className="size-10 icon " />
                  </div>
              ...
              <div className="w-1/3 px-4 pt-20 pb-20 text-white ">
                <div className="flex flex-col items-center text-center">
                  <div className="bg-[#016241]  w-22 h-22 flex justify-center items-center rounded-full absolute top-[-3.5rem]">
                    <FaPhoneAlt className="size-10 icon " />
                  </div>
              ...
              <div className="w-1/3 px-4 pt-20 pb-20 text-white ">
                <div className="flex flex-col items-center text-center">
                  <div className="bg-[#016241]  w-22 h-22 flex justify-center items-center rounded-full absolute top-[-3.5rem]">
                    <MdEmail className="size-10 icon " />
                  </div>
